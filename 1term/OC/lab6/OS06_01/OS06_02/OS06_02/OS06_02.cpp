...
int main()
{
	...
	threads[0] = createThread((LPTHREAD_START_ROUTINE)loop, (char*)"child-A");
	threads[1] = createThread((LPTHREAD_START_ROUTINE)loop, (char*)"child-B");
