...
app.get('/', (req, res) => {
    ...
    // Отправляем открытые параметры и публичный ключ сервера
    res.json({
        sessionId,
...
app.get('/resource', (req, res) => {
    ...
    try {
        const fileContent = `${student.surname} ${student.firstname} ${student.middlename}`; // Здесь должна быть ФИО студента

        const encryptedData = encryptData(fileContent, session.sessionKey);
